...
<head>
    ...
    <title>{{ config('app.name', 'HagaPlus') }} - HR Management System</title>
...
<body class="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen">
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">
                        {{ config('app.name', 'HagaPlus') }}
                    </div>
                </div>
                <div class="hidden md:flex items-center space-x-8">
                    <a href="#features"
                        class="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Features</a>
                    <a href="#pricing"
                        class="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Pricing</a>
                    <a href="{{ route('login') }}"
                        class="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Login</a>
    ...
    <main>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="text-center lg:text-left">
                        <h1
                            ...
                            <span class="block">Powerful HR Management</span>
                            <span class="block text-blue-600 dark:text-blue-400">For Modern Businesses</span>
                        </h1>
                        <p class="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto lg:mx-0">
                            Streamline your HR processes, manage employees efficiently, and focus on growing your
                            business with our comprehensive HR management solution.
                        </p>
                        <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <a href="{{ route('register') }}"
                                class="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl">
                                Get Started Free
                            ...
                            <a href="#features"
                                class="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-blue-600 dark:text-blue-400 bg-white dark:bg-gray-800 rounded-lg border-2 border-blue-600 dark:border-blue-400 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors">
                                Learn More
                            </a>
                        </div>
                        <div
                            class="mt-8 flex items-center justify-center lg:justify-start space-x-2 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div class="relative">
                        <div class="relative z-10 rounded-2xl overflow-hidden shadow-2xl">
                            <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
                                alt="HR Management Dashboard" class="w-full h-auto rounded-2xl">
                        </div>
                        <div
                            class="absolute -bottom-6 -left-6 w-32 h-32 bg-blue-200 dark:bg-blue-900 rounded-full -z-10">
                        </div>
                        <div
                            class="absolute -top-6 -right-6 w-24 h-24 bg-yellow-200 dark:bg-yellow-900 rounded-full -z-10">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="features" class="py-20 bg-white dark:bg-gray-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center max-w-4xl mx-auto mb-16">
                    <span
                        class="inline-block px-4 py-2 text-sm font-semibold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 rounded-full mb-4">
                        Powerful Features
                    </span>
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-300">
                        Our comprehensive HR platform provides all the tools you need to streamline your HR processes
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <!-- Feature 1 -->
                    <div
                        class="feature-card bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700">
                        <div
                            class="w-14 h-14 bg-blue-100 dark:bg-blue-900/40 rounded-xl flex items-center justify-center mb-6">
                            <i class="fas fa-users text-2xl text-blue-600 dark:text-blue-400"></i>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Employee Management</h3>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">
                            Centralize all employee data, documents, and information in one secure, easy-to-access
                            platform.
                        </p>
                        <a href="#" class="inline-flex items-center text-blue-600 dark:text-blue-400 font-medium group">
                            Learn more
                    ...
                    <div
                        class="feature-card bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700">
                        <div
                            class="w-14 h-14 bg-green-100 dark:bg-green-900/40 rounded-xl flex items-center justify-center mb-6">
                            <i class="fas fa-calendar-check text-2xl text-green-600 dark:text-green-400"></i>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Leave & Attendance</h3>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">
                            Automate leave requests, approvals, and tracking with our intuitive attendance management
                            system.
                        </p>
                        <a href="#"
                            class="inline-flex items-center text-green-600 dark:text-green-400 font-medium group">
                            Learn more
                            <svg class="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7">
                    ...
                    <div
                        class="feature-card bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700">
                        <div
                            class="w-14 h-14 bg-purple-100 dark:bg-purple-900/40 rounded-xl flex items-center justify-center mb-6">
                            <i class="fas fa-file-invoice-dollar text-2xl text-purple-600 dark:text-purple-400"></i>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Payroll Processing</h3>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">
                            Simplify payroll with automated calculations, tax compliance, and direct deposit processing.
                        </p>
                        <a href="#"
                            class="inline-flex items-center text-purple-600 dark:text-purple-400 font-medium group">
                            Learn more
                            <svg class="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7">
                    ...
                    <div
                        class="feature-card bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700">
                        <div
                            class="w-14 h-14 bg-yellow-100 dark:bg-yellow-900/40 rounded-xl flex items-center justify-center mb-6">
                            <i class="fas fa-chart-line text-2xl text-yellow-600 dark:text-yellow-400"></i>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Performance Management</h3>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">
                            Set goals, track progress, and conduct performance reviews with our comprehensive tools.
                        </p>
                        <a href="#"
                            class="inline-flex items-center text-yellow-600 dark:text-yellow-400 font-medium group">
                            Learn more
                            <svg class="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7">
                    ...
                    <div
                        class="feature-card bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700">
                        <div
                            class="w-14 h-14 bg-red-100 dark:bg-red-900/40 rounded-xl flex items-center justify-center mb-6">
                            <i class="fas fa-bell text-2xl text-red-600 dark:text-red-400"></i>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">Real-time Analytics</h3>
                        <p class="text-gray-600 dark:text-gray-300 mb-4">
                            Make data-driven decisions with comprehensive HR analytics and reporting tools.
                        </p>
                        <a href="#" class="inline-flex items-center text-red-600 dark:text-red-400 font-medium group">
                            Learn more
                            <svg class="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7">
                    ...
                    <div
                        class="feature-card bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700">
                        <div
                            class="w-14 h-14 bg-indigo-100 dark:bg-indigo-900/40 rounded-xl flex items-center justify-center mb-6">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mb-4">
                            Bank-level security and compliance to protect your sensitive HR data and employee
                            information.
                        </p>
                        <a href="#"
                            class="inline-flex items-center text-indigo-600 dark:text-indigo-400 font-medium group">
                            Learn more
                            <svg class="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7">
        ...
        <section id="pricing" class="py-20 bg-gray-50 dark:bg-gray-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    ...
                    <div
                        ...
                        <div class="p-8">
                            ...
                            <div class="mb-8">
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Billed annually at $348</p>
                            </div>
                            <a href="{{ route('register') }}"
                                class="block w-full text-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                                Start Free Trial
                            </a>
                        </div>
                        <div
                            class="border-t border-gray-200 dark:border-gray-700 px-8 py-6 bg-gray-50 dark:bg-gray-700/30">
                            ...
                            <ul class="space-y-3">
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-600 dark:text-gray-300">Up to 10 employees</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <span class="text-gray-600 dark:text-gray-300">Basic employee management</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <span class="text-gray-600 dark:text-gray-300">Leave & attendance tracking</span>
                                </li>
                    ...
                    <!-- Popular Plan -->
                    <div
                        class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border-2 border-blue-500 transform scale-105 z-10">
                        <div class="p-8">
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Professional</h3>
                                    <p class="text-gray-600 dark:text-gray-300">Best for growing businesses</p>
                                </div>
                                <span
                            ...
                            <div class="mb-8">
                                ...
                                <span class="text-gray-600 dark:text-gray-400">/month</span>
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Billed annually at $948</p>
                            </div>
                            <a href="{{ route('register') }}"
                                class="block w-full text-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                                Start Free Trial
                        ...
                        <div
                            class="border-t border-gray-200 dark:border-gray-700 px-8 py-6 bg-gray-50 dark:bg-gray-700/30">
                            <h4 class="font-semibold text-gray-900 dark:text-white mb-4">Everything in Starter, plus:
                            </h4>
                            <ul class="space-y-3">
                                <li class="flex items-start">
                                    <svg class="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none"
                                    ...
                                    <span class="text-gray-600 dark:text-gray-300">Up to 50 employees</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <span class="text-gray-600 dark:text-gray-300">Advanced employee management</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <span class="text-gray-600 dark:text-gray-300">Performance management</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span class="text-gray-600 dark:text-gray-300">Basic payroll processing</span>
                                </li>
                                <li class="flex items-start opacity-50">
                                    <svg class="h-5 w-5 text-gray-400 mr-2 mt-0.5 flex-shrink-0" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <span class="text-gray-400">Dedicated account manager</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="p-8">
                            ...
                            <p class="text-gray-600 dark:text-gray-300 mb-6">For large organizations with complex needs
                            </p>
                            <div class="mb-8">
                                <span class="text-4xl font-bold text-gray-900 dark:text-white">Custom</span>
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Tailored solutions for your
                                    business</p>
                            </div>
                            <a href="#contact"
                                class="block w-full text-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:hover:bg-blue-900/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                                Contact Sales
                            </a>
                        </div>
                        <div
                            class="border-t border-gray-200 dark:border-gray-700 px-8 py-6 bg-gray-50 dark:bg-gray-700/30">
                            <h4 class="font-semibold text-gray-900 dark:text-white mb-4">Everything in Professional,
                                plus:</h4>
                            <ul class="space-y-3">
                                <li class="flex items-start">
                                    <svg class="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none"
                                    ...
                                    <span class="text-gray-600 dark:text-gray-300">Unlimited employees</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <span class="text-gray-600 dark:text-gray-300">Custom onboarding & training</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <span class="text-gray-600 dark:text-gray-300">Advanced security & compliance</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
        ...
        <section class="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="text-3xl md:text-4xl font-bold mb-6">Ready to transform your HR management?</h2>
                <p class="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
                    Join thousands of businesses that trust our platform to manage their most valuable asset - their
                    people.
                </p>
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="{{ route('register') }}"
                        class="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-blue-700 bg-white hover:bg-blue-50 md:py-4 md:text-lg md:px-10 transition-colors">
                        Start Your Free Trial
                    </a>
                    <a href="#features"
                        class="inline-flex items-center justify-center px-8 py-3 border-2 border-white text-base font-medium rounded-md text-white hover:bg-white hover:bg-opacity-10 md:py-4 md:text-lg md:px-10 transition-colors">
                        Learn More
                    </a>
                </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div class="col-span-2">
                        <div class="flex items-center mb-6">
                            <span
                                class="text-2xl font-bold bg-gradient-to-r from-blue-400 to-indigo-500 bg-clip-text text-transparent">HagaPlus</span>
                        </div>
                        <p class="text-gray-400 mb-6 max-w-md">
                            Empowering businesses with modern HR solutions. Streamline your HR processes and focus on
                ...
                <div class="border-t border-gray-800 pt-8">
                    <div class="flex flex-col md:flex-row justify-between items-center">
                        <p class="text-gray-400 text-sm">
                            &copy; {{ date('Y') }} HagaPlus. All rights reserved.
                        </p>
                    ...
                    <div class="mt-8 text-center text-gray-500 text-sm">
                        <p>HagaPlus is a modern HR management platform that helps businesses streamline their HR
                            processes and improve team productivity.</p>
                    </div>
                </div>
            </div>
        </footer>
    ...
    @if (Route::has('login'))
        <div class="fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            @else
                <a href="{{ route('login') }}"
                    class="text-sm text-gray-700 dark:text-gray-500 hover:text-gray-900 dark:hover:text-white">Log in</a>

                @if (Route::has('register'))
                    <a href="{{ route('register') }}"
                        class="ml-4 text-sm text-gray-700 dark:text-gray-500 hover:text-gray-900 dark:hover:text-white">Register</a>
                @endif
            @endauth
        </div>
    @endif
