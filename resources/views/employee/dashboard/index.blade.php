            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-6 rounded-lg">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <h3 class="text-lg font-semibold text-red-800 dark:text-red-200">Profil Karyawan Tidak Ditemukan</h3>
                            <p class="mt-2 text-sm text-red-700 dark:text-red-300">{{ $error }}</p>
                            <p class="mt-3 text-sm text-red-700 dark:text-red-300">
                                Silakan hubungi administrator untuk mendaftarkan akun Anda sebagai karyawan.
                            </p>
                            <div class="mt-4">
