        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 md:mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">Add Payment Method</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-400">Create a new payment method for subscriptions</p>
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <form method="POST" action="{{ route('superadmin.payment-methods.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <!-- QRIS Fields -->
                    <div id="qrisFields" class="hidden space-y-6">
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Upload QRIS code image (JPEG, PNG, JPG, GIF). Max 2MB.</p>
                            @error('qris_image')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" id="description" rows="3"
                                  class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white sm:text-sm"
                                  placeholder="Optional description or instructions">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex items-center justify-end space-x-3">
                        ...
                        <button type="submit" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
                            <i class="fa-solid fa-save mr-2"></i>Create Payment Method
                        </button>
                    </div>
                </form>
            </div>
