    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <p class="mt-2 text-gray-600">Update package details in the system</p>
            </div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3" 
                                          class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('description') border-red-300 @enderror">{{ old('description', $package->description) }}</textarea>
                                @error('description')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="number" name="price" id="price" value="{{ old('price', $package->price) }}" min="0" step="0.01"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2 space-y-2">
                                        @php
                                            $selectedFeatures = old('features', $package->features ?? []);
                                        @endphp
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" name="features[]" value="qr" {{ in_array('qr', $selectedFeatures) ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600">
                                            <span class="ml-2 text-sm text-gray-700">QR Code Attendance</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" name="features[]" value="gps" {{ in_array('gps', $selectedFeatures) ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600">
                                            <span class="ml-2 text-sm text-gray-700">GPS Location</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" name="features[]" value="face_id" {{ in_array('face_id', $selectedFeatures) ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600">
                                            <span class="ml-2 text-sm text-gray-700">Face ID Recognition</span>
                                        </label>
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" name="features[]" value="payroll" {{ in_array('payroll', $selectedFeatures) ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600">
