    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-400">Design a new subscription package for your customers.</p>
            </div>

            <form method="POST" action="{{ route('superadmin.packages.store') }}" class="space-y-8">
                @csrf
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6 space-y-6">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="e.g. Professional Plan"
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3" placeholder="Briefly describe what this package offers..."
                                      class="block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm transition-colors @error('description') border-red-300 @enderror">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <input type="number" name="price" id="price" value="{{ old('price') }}" min="0" step="0.01" placeholder="0"
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="max_admins" id="max_admins" value="{{ old('max_admins', 1) }}" min="1"
                                        ...
                                        @foreach($perms as $key => $label)
                                            <label class="flex items-start cursor-pointer">
                                                <div class="flex items-center h-5">
                                                    <input type="checkbox" name="permissions[]" value="{{ $key }}" class="rounded border-gray-300 dark:border-gray-600 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition-colors">
                                                </div>
