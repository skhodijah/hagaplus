    ...
    <div class="py-6 md:py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 md:mb-8">
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">Financial Overview</h1>
                <p class="mt-1 text-gray-600 dark:text-gray-400">Monitor revenue, payments, and financial metrics</p>
            </div>
