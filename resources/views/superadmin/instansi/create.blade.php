<x-superadmin-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900">Create New Instansi</h1>
                <p class="mt-2 text-gray-600">Add a new instansi to the system</p>
            </div>

            <div class="bg-white shadow sm:rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <form method="POST" action="{{ route('superadmin.instansi.store') }}">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <select name="status_langganan" id="status_langganan" 
                                    ...
                                    <option value="active" {{ old('status_langganan') == 'active' ? 'selected' : '' }}>Active</option>
                                    <option value="inactive" {{ old('status_langganan') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                    <option value="suspended" {{ old('status_langganan') == 'suspended' ? 'selected' : '' }}>Suspended</option>
                                </select>
