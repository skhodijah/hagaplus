<x-admin-layout>
    <x-page-header title="{{ __('Division Management') }}" class="mb-6">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($divisions as $division)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">{{ $division->code }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">{{ $division->employees->count() }} employees</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('admin.divisions.edit', $division) }}" class="text-blue-600 hover:text-blue-900 mr-3">
