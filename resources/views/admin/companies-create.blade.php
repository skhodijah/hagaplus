                    ...
                    <form method="POST" action="{{ route('admin.companies.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="max_employees" class="block mt-1 w-full" type="number" name="max_employees" :value="old('max_employees', 10)" min="1" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="max_branches" class="block mt-1 w-full" type="number" name="max_branches" :value="old('max_branches', 1)" min="1" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="subscription_start" class="block mt-1 w-full" type="datetime-local" name="subscription_start" :value="old('subscription_start')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="subscription_end" class="block mt-1 w-full" type="datetime-local" name="subscription_end" :value="old('subscription_end')" />
