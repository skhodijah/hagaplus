<x-admin-layout>
    <div class="py-2">
        <x-page-header
            ...
            subtitle="Create a new attendance record for an employee"
        />
            ...
            <form method="POST" action="{{ route('admin.attendance.store') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" id="attendance_date" name="attendance_date" value="{{ old('attendance_date') }}"
                ...
                <div class="mt-8 flex items-center justify-end space-x-4">
                    ...
                    <button type="submit"
                        ...
                        <i class="fa-solid fa-save mr-2"></i>Create Attendance Record
                    </button>
                </div>
            </form>
        </div>
