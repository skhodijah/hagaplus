<x-admin-layout>
            ...
            <form method="POST" action="{{ route('admin.branches.store') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="radius" name="radius" value="{{ old('radius', 100) }}" min="10" max="1000"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <!-- Map Instructions -->
                            <div class="absolute top-3 left-3 bg-white dark:bg-gray-800 px-3 py-2 rounded-lg shadow-lg max-w-xs" style="z-index: 1000;">
                            ...
                            <!-- Coordinate Display -->
                            <div id="coordinate-display" class="absolute bottom-3 left-3 bg-white dark:bg-gray-800 px-3 py-2 rounded-lg shadow-lg hidden" style="z-index: 1000;">
                                <div class="text-xs">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <input type="text" id="lat-display" readonly
                                               ...
                                               value="{{ old('latitude') ? number_format(old('latitude'), 6) : 'Not set' }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <input type="text" id="lng-display" readonly
                                               ...
                                               value="{{ old('longitude') ? number_format(old('longitude'), 6) : 'Not set' }}">
                                    </div>
                                </div>
                            </div>
                            <div class="bg-purple-50 dark:bg-purple-900/20 p-3 rounded-lg">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm font-semibold text-purple-900 dark:text-purple-100">{{ old('radius', 100) }}m</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-8 flex items-center justify-end space-x-4">
                    ...
                    <button type="submit"
                        ...
                        <i class="fa-solid fa-save mr-2"></i>Create Branch
                    </button>
                </div>
            </form>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const defaultLat = {{ old('latitude') ? old('latitude') : -6.208763 }};
            const defaultLng = {{ old('longitude') ? old('longitude') : 106.845599 }};
            const defaultRadius = {{ old('radius') ? old('radius') : 100 }};
            ...
            function setLocation(lat, lng) {
                ...
                marker.bindPopup(`
                    <div class="text-center">
                        <h4 class="font-semibold text-gray-900">New Branch Location</h4>
