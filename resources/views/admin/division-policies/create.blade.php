<x-admin-layout>
    <div class="py-2">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <x-page-header
                title="Create Division Policy"
                subtitle="Create a policy for a specific division"
            ...
            <form method="POST" action="{{ route('admin.division-policies.store') }}" id="policyForm">
                @csrf
                ...
                <x-section-card title="Basic Information">
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            <label for="division_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Division <span class="text-red-500">*</span></label>
                            <select name="division_id" id="division_id" required
                                    class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white sm:text-sm @error('division_id') border-red-300 dark:border-red-600 @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                   ...
                                   placeholder="e.g., Standard Division Policy">
                            @error('name')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                      ...
                                      placeholder="Describe this policy...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </x-section-card>
                ...
                <x-section-card title="Attendance Rules">
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <label class="flex items-center">
                                <input type="checkbox" name="skip_weekends" value="1" {{ old('skip_weekends') ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
