    ...
    <div class="py-2">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <x-page-header
                ...
                subtitle="Create a reusable template for employee policies"
            ...
            <form method="POST" action="{{ route('admin.employee-policy-templates.store') }}" id="templateForm">
                @csrf
                ...
                <x-section-card title="Basic Information">
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Template Name <span class="text-red-500">*</span></label>
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                   ...
                                   placeholder="e.g., Standard 9-5, Remote Work, Part-Time">
                            @error('name')
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Default template will be pre-selected when creating new policies</p>
                        </div>
                    </div>
                </x-section-card>
                ...
                <div class="mt-6 flex items-center justify-end space-x-3">
                    ...
                    <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200">
                        <i class="fa-solid fa-save mr-2"></i>Create Template
                    </button>
                </div>
            </form>
        </div>
