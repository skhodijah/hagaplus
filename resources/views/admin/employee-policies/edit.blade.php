<x-admin-layout>
    <div class="py-2">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('admin.employee-policies.update', $employeePolicy) }}" id="policyForm">
                @csrf
                @method('PUT')
                ...
                <x-section-card title="Work Schedule">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="work_hours_per_day" id="work_hours_per_day" value="{{ old('work_hours_per_day', $employeePolicy->work_hours_per_day) }}" min="1" max="24"
                                   class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                            @php
                                ...
                                $selectedDays = old('work_days', $employeePolicy->work_days ?? []);
                            @endphp
                ...
                <x-section-card title="Attendance Rules">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="grace_period_minutes" id="grace_period_minutes" value="{{ old('grace_period_minutes', $employeePolicy->grace_period_minutes) }}" min="0" max="120"
                                   class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white sm:text-sm">
                        </div>

                        <div>
                            <label for="max_late_minutes" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Max Late Minutes</label>
                            <input type="number" name="max_late_minutes" id="max_late_minutes" value="{{ old('max_late_minutes', $employeePolicy->max_late_minutes) }}" min="0" max="480"
                                   class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white sm:text-sm">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="early_leave_grace_minutes" id="early_leave_grace_minutes" value="{{ old('early_leave_grace_minutes', $employeePolicy->early_leave_grace_minutes) }}" min="0" max="120"
                                   class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white sm:text-sm">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="allowed_radius_meters" id="allowed_radius_meters" value="{{ old('allowed_radius_meters', $employeePolicy->allowed_radius_meters) }}" min="0" max="10000"
                                   class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-3">
                            <label class="flex items-center">
                                <input type="checkbox" name="require_location_check" value="1" {{ old('require_location_check', $employeePolicy->require_location_check) ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Require location check</span>
                            </label>

                            <label class="flex items-center">
                                <input type="checkbox" name="allow_overtime" value="1" {{ old('allow_overtime', $employeePolicy->allow_overtime) ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Allow overtime</span>
                            </label>

                            <label class="flex items-center">
                                <input type="checkbox" name="can_work_from_home" value="1" {{ old('can_work_from_home', $employeePolicy->can_work_from_home) ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center">
                                <input type="checkbox" name="flexible_hours" value="1" {{ old('flexible_hours', $employeePolicy->flexible_hours) ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Flexible working hours</span>
                            </label>

                            <label class="flex items-center">
                                <input type="checkbox" name="skip_weekends" value="1" {{ old('skip_weekends', $employeePolicy->skip_weekends) ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Skip weekends</span>
                            </label>

                            <label class="flex items-center">
                                <input type="checkbox" name="skip_holidays" value="1" {{ old('skip_holidays', $employeePolicy->skip_holidays) ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6" id="overtimeSettings" style="display: {{ old('allow_overtime', $employeePolicy->allow_overtime) ? 'grid' : 'none' }};">
                        <div>
                            ...
                            <input type="number" name="max_overtime_hours_per_day" id="max_overtime_hours_per_day" value="{{ old('max_overtime_hours_per_day', $employeePolicy->max_overtime_hours_per_day) }}" min="0" max="12"
                                   class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white sm:text-sm">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="max_overtime_hours_per_week" id="max_overtime_hours_per_week" value="{{ old('max_overtime_hours_per_week', $employeePolicy->max_overtime_hours_per_week) }}" min="0" max="60"
                                   class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white sm:text-sm">
                        </div>
                    </div>
                </x-section-card>
                ...
                <x-section-card title="Leave Policies">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="annual_leave_days" id="annual_leave_days" value="{{ old('annual_leave_days', $employeePolicy->annual_leave_days) }}" min="0" max="365"
                                   class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white sm:text-sm">
                        </div>

                        <div>
                            <label for="sick_leave_days" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Sick Leave Days</label>
                            <input type="number" name="sick_leave_days" id="sick_leave_days" value="{{ old('sick_leave_days', $employeePolicy->sick_leave_days) }}" min="0" max="365"
                                   class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white sm:text-sm">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="personal_leave_days" id="personal_leave_days" value="{{ old('personal_leave_days', $employeePolicy->personal_leave_days) }}" min="0" max="365"
                                   class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white sm:text-sm">
                        </div>

                        <div class="flex items-center pt-6">
                            <label class="flex items-center">
                                <input type="checkbox" name="allow_negative_leave_balance" value="1" {{ old('allow_negative_leave_balance', $employeePolicy->allow_negative_leave_balance) ? 'checked' : '' }}
                                       class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
