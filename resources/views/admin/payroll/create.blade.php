<x-admin-layout>
    <div class="py-2">
        <x-page-header
            title="Add New Payroll Record"
            subtitle="Create a new payroll record for an employee"
        />
            ...
            <form method="POST" action="{{ route('admin.payroll.store') }}" id="payroll-form">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select id="period_month" name="period_month"
                                    ...
                                    required>
                                @for ($m = 1; $m <= 12; $m++)
                                    <option value="{{ $m }}" {{ old('period_month', date('m')) == $m ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select id="payment_status" name="payment_status"
                                ...
                                required>
                            <option value="draft" {{ old('payment_status', 'draft') == 'draft' ? 'selected' : '' }}>Draft</option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="notes" name="notes" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white @error('notes') border-red-500 @enderror">{{ old('notes') }}</textarea>
                        @error('notes')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="mt-8 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <p id="total-gross" class="text-lg font-semibold text-gray-900 dark:text-white">Rp 0</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Total Deductions</label>
                            <p id="total-deductions" class="text-lg font-semibold text-red-600 dark:text-red-400">Rp 0</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Net Salary</label>
                            <p id="net-salary" class="text-lg font-semibold text-green-600 dark:text-green-400">Rp 0</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400">Status</label>
                            <p id="summary-status" class="text-lg font-semibold text-gray-900 dark:text-white">-</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 flex items-center justify-end space-x-4">
                    ...
                    <button type="submit"
                        ...
                        <i class="fa-solid fa-save mr-2"></i>Create Payroll Record
                    </button>
                </div>
            </form>
        </div>
