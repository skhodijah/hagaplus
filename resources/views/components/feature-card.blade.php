@props([
    ...
    'iconClass' => 'text-[#008159] dark:text-[#76E47E]',
    'bgClass' => 'bg-[#D2FE8C]/40 dark:bg-[#008159]/40'
])

<div class="feature-card bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
    <div class="w-14 h-14 {{ $bgClass }} rounded-xl flex items-center justify-center mb-6">
    ...
    <a href="#" class="{{ $iconClass }} font-medium inline-flex items-center">
        Learn more
