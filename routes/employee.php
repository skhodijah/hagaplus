...
Route::middleware(['auth', 'role:employee', 'verified'])->prefix('employee')->name('employee.')->group(function () {
    ...
    Route::post('/attendance/revision', [AttendanceController::class, 'storeRevision'])->name('attendance.revision.store');
